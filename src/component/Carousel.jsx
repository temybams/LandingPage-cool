...
function Carousel() {
    ...
    const prevSlide = () => {
        setCurrentSlide((prevSlide) => (prevSlide - 1 + items4.length) % items4.length);
    };
        ...
        <div className="carousel">
            <div className="slides">
                {items4.map((item, index) => (
                    <div className={`slide ${index === currentSlide ? 'active' : ''}`} key={item.title}>
                                ...
                                <div className="lists">
                                    <div className="list flex flex-col gap-3">
                                        <div className="flex gap-5 items-center">
                                            <div className="w-6 h-2 rounded-md" style={{ backgroundColor: item.color }}></div>
                                            <p>{item.context1}</p>
                                        </div>
                                        <div className="flex gap-5 items-center">
                                            <div className="w-6 h-2 bg-[#50589F] rounded-md" style={{ backgroundColor: item.color }}></div>
                                            <p>{item.context2}</p>
                                        </div>
                                        <div className="flex gap-5 items-center">
                                            <div className="w-6 h-2 rounded-md" style={{ backgroundColor: item.color }}></div>
